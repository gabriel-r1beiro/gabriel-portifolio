...
export const Introduction = () => {
  ...
  return (
    <article className="max-w-screen-lg px-2 w-full mt-24">
      <div className="flex justify-between">
        <header className="flex mt-10 flex-col items-start gap-2 max-w-xl ">
          ...
          <p className="pr-2">
            ...
            experiência em programação, inicialmente focado em automação com
            Python para projetos pessoais. Recentemente, descobri minha paixão
            pelo desenvolvimento web e estou em busca da minha primeira
          ...
          <div className="flex gap-4">
            <button className="flex gap-2 items-center mt-3 bg-black hover:bg-gray-700 text-white py-2 px-7 rounded-sm">
              <FaGithub /> GitHub
            </button>
            <button className="flex gap-2 items-center mt-3 bg-blue-700 hover:bg-blue-900 text-white py-2 px-6 rounded-sm">
              <FaLinkedin /> Linkedin
            </button>
          </div>
        </header>
